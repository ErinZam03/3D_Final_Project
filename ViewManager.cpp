...
void ViewManager::PrepareSceneView()
{
	...
	// Define the projection matrix based on whether orthographic or perspective projection is enabled
	if (bOrthographicProjection)
	{
		// Orthographic projection: define a simple orthographic view
		projection = glm::ortho(-10.0f, 10.0f, -10.0f, 10.0f, 0.1f, 100.0f);  // Adjust the range as needed for your scene
	}
	else
	{
